        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedByPtId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NutritionPlans_AspNetUsers_CreatedByPtId",
                        column: x => x.CreatedByPtId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingPlans_AspNetUsers_CreatedByPtId",
                        column: x => x.CreatedByPtId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NutritionPlans_CreatedByPtId",
                table: "NutritionPlans",
                column: "CreatedByPtId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingPlans_CreatedByPtId",
                table: "TrainingPlans",
                column: "CreatedByPtId");
        }
